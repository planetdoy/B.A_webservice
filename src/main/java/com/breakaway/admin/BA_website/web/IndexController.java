...
import com.breakaway.admin.BA_website.config.auth.LoginUser;
...
public class IndexController {
    ...
    public String index(Model model, @LoginUser SessionUser user){              // (1-2)
        ...
        /*
        SessionUser user = (SessionUser) httpSession.getAttribute("user");      // (1-1)
        */
        ...
        /*
            Model
             ...
             1-1. (SessionUser) httpSession.getAttribute("user")
             ...
             1-2. @LoginUser SessionUser user
                - 기존에 (SessionUser) httpSession.getAttribute("user")로 가져오던 세션 정보 값이 개선 되었습니다.
